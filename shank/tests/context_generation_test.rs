...
fn test_all_anchor_constraint_combinations() {
    ...
    pub struct AnchorStyleAccounts<'info> {
        ...
        pub no_constraints: &'info AccountInfo<'info>,
    }
...
fn test_backward_compatible_constraint_names() {
    ...
    pub struct BackwardCompatAccounts<'info> {
        #[account(writable)]
        pub writable_account: &'info AccountInfo<'info>,

        #[account(write)]
        pub write_account: &'info AccountInfo<'info>,

        #[account(writ)]
        pub writ_account: &'info AccountInfo<'info>,

        #[account(w)]
        pub w_account: &'info AccountInfo<'info>,

        #[account(sign)]
        pub sign_account: &'info AccountInfo<'info>,

        #[account(sig)]
        pub sig_account: &'info AccountInfo<'info>,

        #[account(s)]
        pub s_account: &'info AccountInfo<'info>,

        #[account(optional)]
        pub opt_account: Option<&'info AccountInfo<'info>>,

        #[account(option)]
        pub option_account: Option<&'info AccountInfo<'info>>,
    }
...
fn test_single_account_struct() {
    ...
    pub struct SingleAccount<'info> {
        ...
        pub only_account: &'info AccountInfo<'info>,
    }
...
fn test_generic_lifetimes_work() {
    ...
    pub struct GenericAccounts<'info> {
        ...
        pub account2: &'info AccountInfo<'info>,
    }
    ...
    pub struct MultipleGenerics<'info> {
        pub info_account: &'info AccountInfo<'info>,
