...
fn test_accounts_with_instruction_integration() {
    ...
    pub enum TokenInstruction {
        ...
        CreateToken { decimals: u8, supply: u64 },
    }
...
fn test_multiple_instructions_different_accounts() {
    ...
    pub struct InitializeAccounts<'info> {
        ...
        pub target: &'info AccountInfo<'info>,
    ...
    pub struct TransferAccounts<'info> {
        ...
        pub fee_account: Option<&'info AccountInfo<'info>>,
    }
...
fn test_complex_program_structure() {
    ...
    pub struct CreateAccounts<'info> {
        ...
        pub new_account: &'info AccountInfo<'info>,
    ...
    pub struct AdminAccounts<'info> {
        ...
        pub co_signer: Option<&'info AccountInfo<'info>>,
    }
    ...
    pub enum ComplexProgram {
        ...
        Create { space: u64, seed: String },

        #[accounts(UpdateAccounts)]
        Update { new_data: Vec<u8> },

        #[accounts(AdminAccounts)]
        SetConfig { new_fee: u64, enabled: bool },
